...
const RENT_RANGES = [
  ...
  { min: 100000, max: 999999, label: "1L+" },
];
...
const PREFERRED_TENANT = ["Family", "Bachelor Male", "Bachelor Female", "Company", "Any"];
const PARKING_OPTIONS = ["Car", "Bike", "Both", "None"];
const FLOOR_OPTIONS = ["Ground", "1-3", "4-7", "8-12", "13+"];
const PROPERTY_TYPES_RESIDENTIAL = ["Apartment", "Independent House", "Villa", "Builder Floor", "Penthouse", "Studio"];
const PROPERTY_TYPES_COMMERCIAL = ["Office Space", "Shop", "Showroom", "Warehouse", "Industrial Building", "Co-Working"];
const CARPET_AREA_OPTIONS = ["Under 500 sqft", "500-1000 sqft", "1000-2000 sqft", "2000-5000 sqft", "5000+ sqft"];
const BUSINESS_TYPE_OPTIONS = ["IT/Software", "Retail", "Manufacturing", "Healthcare", "Education", "Hospitality", "Any"];
const POWER_LOAD_OPTIONS = ["Under 5 KW", "5-10 KW", "10-25 KW", "25-50 KW", "50+ KW"];
